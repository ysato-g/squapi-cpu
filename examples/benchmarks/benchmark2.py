...
#==============================================================================
#--- QUAPI paramters
Dkmax   = 9                 # The maximum number of memory steps
theta   = 0.e-6             # threshold for propagator
t       = 999 * fs          # The total time          
Dt      = 18.5 * fs         # Time slice of path integral
...
if graphics == True:
    ...
    ax.annotate(r'${\rm T=77K}$', xy=(675, 0.9), fontsize='x-large')
    ax.annotate(r'$\lambda = {\rm J_{da}}\,/\,5$', xy=(675, 0.7), fontsize='x-large')
    plt.show()
