 ...
 * Description: the main function of squapi_cont_omp 
 * Notes: 
 *      - Not compatible with squapi_mpi
...
int main(int argc, char* argv[])
{
    ...
    /****** CONT ONLY *********************************************/
    // load D.dat and stores it into D:
    load_D(N0, theta, D);
    /*************************************************************/
    ...
    /************************************************************************************* 
     *                     BELOW THE SAME AS squpai_omp.cp                               *
    ...
    getCnmap(C[Dkmax], Cnmap); // use serial version
