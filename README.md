...
Scalable QuAPI (S-QuAPI) is one of the recently-developed flavors of QuAPI algorithm that specifically targeted at scalability of parallel computation and small memory consumption.
